      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <span
              ...
              className="text-2xl font-normal italic text-white"
            >
              Mega Zoé
            </span>
          ...
          <div>
            <h3
              className="text-xs tracking-widest uppercase text-[#c9a96e] mb-4"
          ...
          <div>
            ...
            <h3
              className="text-xs tracking-widest uppercase text-[#c9a96e] mt-6 mb-4"
              style={{ fontFamily: "'Lato', sans-serif" }}
            >
              Redes Sociales
            </h3>
            <div className="flex items-center gap-4">
              {socialLinks.map(({ href, label, icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="text-gray-400 hover:text-[#c9a96e] transition-colors duration-200"
                >
                  {icon}
                </a>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-xs">
            © {new Date().getFullYear()} Iglesia Mega Zoé. Todos los derechos reservados.
          </p>
          <p
